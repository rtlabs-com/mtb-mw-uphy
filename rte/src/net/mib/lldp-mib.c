   ...
   void * value)
{
   ...
   case 1:
   {
      ...
      rte_lldp_port_list_t port_list;

      rte_snmp_get_port_list (pnal_snmp.snmp_cfg, &port_list);
   ...
   void * value)
{
   ...
   case 2:
   {
      ...
      rte_snmp_get_port_id (pnal_snmp.snmp_cfg, port, &port_id);
   ...
   case 4:
   {
      /* lldpLocPortDesc */
      char * v = (char *)value;
      rte_lldp_port_description_t port_desc;

      rte_snmp_get_port_description (pnal_snmp.snmp_cfg, port, &port_desc);
   ...
   void * value)
{
   ...
   case 4:
   {
      ...
      rte_snmp_get_management_port_index (pnal_snmp.snmp_cfg, &port_index);
   ...
   void * value)
{
   ...
   case 1:
   {
      ...
      rte_snmp_get_chassis_id (pnal_snmp.snmp_cfg, &chassis_id);
   ...
   u32_t column)
{
   ...
   case 4:
   {
      ...
      error = rte_snmp_get_peer_chassis_id (pnal_snmp.snmp_cfg, port, &chassis_id);
   ...
   case 6:
   {
      ...
      error = rte_snmp_get_peer_port_id (pnal_snmp.snmp_cfg, port, &port_id);
   ...
   case 8:
   {
      ...
      error =
         rte_snmp_get_peer_port_description (pnal_snmp.snmp_cfg, port, &port_desc);
   ...
   u32_t column)
{
   ...
   case 3:
   {
      ...
      error = rte_snmp_get_peer_management_port_index (
         pnal_snmp.snmp_cfg,
         port,
         &port_index);
