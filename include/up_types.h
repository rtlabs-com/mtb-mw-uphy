...
/*
 * Generated by erpcgen 1.9.1 on Tue Feb 24 15:52:05 2026.
 *
...
typedef struct up_cclink_item_t up_cclink_item_t;
typedef struct up_cclink_module_t up_cclink_module_t;
typedef struct up_cclink_station_t up_cclink_station_t;
typedef struct up_cclink_config_t up_cclink_config_t;
...
struct up_cclink_item_t
{
    uint16_t index;
    bool is_bits;
};

struct up_cclink_module_t
{
    uint16_t n_inputs;
    uint16_t n_outputs;
    up_cclink_item_t * inputs;
    up_cclink_item_t * outputs;
};

struct up_cclink_station_t
{
    uint8_t module_ix;
};

struct up_cclink_config_t
{
    ...
    uint8_t n_modules;
    uint8_t n_stations;
    up_cclink_module_t * modules;
    up_cclink_station_t * stations;
};
